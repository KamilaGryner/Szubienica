const game = {
    currentSentence : null, // pobrane hasło
        ...
        if (this.currentSentence.includes(letter)) {   //jeżeli litera istnieje w haśle
            for (let i=0; i<this.currentSentence.length; i++) {
                if (this.currentSentence[i] === letter) {
                    this.elemSentence.querySelectorAll(".game-sentence-box")[i].innerText = letter; //wstawiamy  wybraną literę
                }
            }
    ...
    randomSentence : function() {
        ...
        this.elemSentence.innerText = ""; //czyszczenie listy
    ...
    startGame : function() {
        ...
        this.randomSentence(); //losujemy hasło 
